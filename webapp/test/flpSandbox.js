		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "maps",
									"targetURL": "#comexamplemaps-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comexamplemaps-display": {
								"semanticObject": "comexamplemaps",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.example.maps",
									"url": sap.ui.require.toUrl("com/example/maps")
								}
							}
						}
					}
